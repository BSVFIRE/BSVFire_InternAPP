...
export function ForstehjelpPreview({ pdfBlob, fileName, onBack, onSave }: ForstehjelpPreviewProps) {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">
                Forhåndsvisning - Førstehjelprapport
              </h2>
