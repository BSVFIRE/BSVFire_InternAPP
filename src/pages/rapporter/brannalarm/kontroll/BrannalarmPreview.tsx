...
interface BrannalarmPreviewProps {
  pdfBlob: Blob
  fileName: string
  rapportType: 'FG790' | 'NS3960'
  onBack: () => void
  onSave: () => Promise<void>
}

export function BrannalarmPreview({ pdfBlob, fileName, rapportType, onBack, onSave }: BrannalarmPreviewProps) {
  ...
  const rapportTittel = rapportType === 'FG790' 
    ? 'Brannalarm Kontrollrapport FG790' 
    : 'Brannalarm Kontrollrapport NS3960'
