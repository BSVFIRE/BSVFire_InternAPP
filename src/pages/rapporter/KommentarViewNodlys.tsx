...
export function KommentarViewNodlys({ anleggId, kundeNavn: _kundeNavn, anleggNavn: _anleggNavn, onBack: _onBack }: KommentarViewProps) {
  ...
  async function leggTilKommentar() {
    ...
    try {
      ...
      // Gi informativ feilmelding basert på feiltype
          ...
          <div className="space-y-4 mt-6">
            ...
            {kommentarer.length === 0 ? (
              ...
              kommentarer.map((kommentar) => (
                <div key={kommentar.id} className="border border-gray-800 rounded-lg p-4 hover:border-yellow-500/20 transition-colors">
