      ...
      {isExpanded && (
        ...
        <div className="space-y-3">
          <textarea
            ...
            placeholder="Skriv en kommentar om brannslanger, observasjoner, avvik eller annen relevant informasjon..."
          />
          ...
          <div className="space-y-4 mt-6">
            ...
            {kommentarer.length === 0 ? (
              ...
              kommentarer.map((kommentar) => (
                <div key={kommentar.id} className="border border-gray-200 dark:border-gray-800 rounded-lg p-4 hover:border-blue-500/20 transition-colors">
