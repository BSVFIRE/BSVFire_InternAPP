-- Clean migration for serviceavtale_tilbud table
...
-- Create indexes
CREATE INDEX idx_serviceavtale_tilbud_kunde ON serviceavtale_tilbud(kunde_id);
CREATE INDEX idx_serviceavtale_tilbud_anlegg ON serviceavtale_tilbud(anlegg_id);
CREATE INDEX idx_serviceavtale_tilbud_kontaktperson ON serviceavtale_tilbud(kontaktperson_id);
CREATE INDEX idx_serviceavtale_tilbud_status ON serviceavtale_tilbud(status);
CREATE INDEX idx_serviceavtale_tilbud_opprettet ON serviceavtale_tilbud(opprettet DESC);
